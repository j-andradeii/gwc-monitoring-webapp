const baseURL = "https://staging.acps.com.au/api"
const baseURL_AUTH = "https://staging.acps.com.au/api/auth"

export const environment = {
  production: false,
  API_URL:  baseURL,
  API_AUTH: baseURL_AUTH,
  ...
  DIRECT_LINK: 'https://staging.acpsfe.jezweb.xyz/members-only'
};
